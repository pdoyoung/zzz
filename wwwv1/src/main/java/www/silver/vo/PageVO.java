...
public class PageVO {
	...
	//page 변수는 현재 페이지의 번호
	private Integer page; // Integer 웹에서 받은 페이지 정보(String)가 없으면 null인데 int는 null을 저장할 수 없다. 오류방지//객체형의정수타입 null을가질수있다
	private int totalCount;//전체 튜플의 수
	//page,totalCount,perPageNum 3개의 변수로 startNo와endNo 값을 자동으로 계산한다
